...
export default function ServicesPage() {
  ...
  const itemsWeHandle = [
    ...
    { icon: TreePine, name: "Gravats & Déchets verts", description: "Matériaux de construction, végétaux" },
  ]
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground text-pretty">
              Ò Debarras vous accompagne dans tous vos projets de débarras avec professionnalisme, efficacité et
              discrétion. De la simple évacuation de meubles aux situations les plus complexes, nous avons la solution
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-4">Que Débarrassons-Nous ?</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Notre mission est de débarrasser tous types de logements et locaux en Corse, en prenant en charge une
              variété d'objets avec professionnalisme et discrétion.
            </p>
          </div>
          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardHeader>
              <div className="flex items-center gap-3 mb-2">
                ...
                <CardTitle className="text-2xl">Notre Engagement Environnemental</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Chez Ò Debarras, nous sommes profondément engagés dans une démarche éco-responsable. Chaque intervention
                est l'occasion de trier, recycler et valoriser un maximum d'objets et de matériaux.
              </p>
              <div className="grid md:grid-cols-3 gap-6 mt-6">
                <div>
                  <h4 className="font-semibold mb-2">Tri Systématique</h4>
                  <p className="text-sm text-muted-foreground">
                    Nous séparons les objets réutilisables, recyclables et les déchets ultimes pour optimiser leur
                    traitement.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Nous travaillons avec des associations et recycleries corses pour donner une seconde vie aux objets.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Traçabilité</h4>
                  <p className="text-sm text-muted-foreground">
                    Nous vous fournissons des certificats de traitement et de recyclage pour une transparence totale.
                  </p>
                </div>
              </div>
            </CardContent>
